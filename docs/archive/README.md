...
These summaries preserve selected decisions and original milestone dates. They describe history, not current setup instructions or proof that a check still passes. Use the [current documentation](../README.md) for implementation and operations.

- [React migration and compatibility](react-migration.md)
