...
from frontend.ui.nicegui.domains.courses.ui_glue import normalize_course_view_mode
from frontend.ui.nicegui.domains.paths.reducers import normalize_path_view_mode, path_matches_state
