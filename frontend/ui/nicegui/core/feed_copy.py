...
def activity_empty_description(*, current_tab: str) -> str:
    ...
    if str(current_tab or "").strip().lower() == "team":
        return "When teammates share or review learning items and paths, updates will appear here."
    return "When teammates review your shared learning items and paths, updates will appear here."
