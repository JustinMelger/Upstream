...
class AiCuratorPageController:
    ...
    async def generate_plan(self, *, goal: str) -> tuple[dict[str, Any], list[dict[str, Any]]]:
        ...
        plan = await self._api.post("/ai/plan", {"goal": str(goal or "").strip()})
    ...
    async def apply_plan(
        ...
        *,
        ...
        for row in list(draft_courses or []):
            ...
            created = await self._api.post("/courses", payload)
